...
export default function FractionalOwnershipPage() {
  ...
  return <div className={styles.page}>
    ...
    <section className={styles.section}><h2 className={styles.sectionTitle}>{ar ? "كيف تعمل الملكية الجزئية؟" : "How Fractional Ownership Works"}</h2><div className={styles.timeline}>{[
      {n:1,icon:"🔍",title:ar?"تصفح واختر":'Browse & Select',desc:ar?"اختر عقاراً من السوق العقاري — شقق، فلل، مكاتب أو فنادق":"Choose a property from the real estate market — apartments, villas, offices, or hotels"},
      {n:2,icon:"📊",title:ar?"تحديد الحصة":'Set Your Fraction',desc:ar?"حدد نسبة الملكية، السعر، الحد الأدنى للاستثمار ونموذج الدخل":"Define the fraction size, price, minimum ticket, and income model"},
      {n:3,icon:"📋",title:ar?"امتثال REGA/RER":'REGA/RER Compliance',desc:ar?"رخصة FAL، تسجيل RER، إفصاحات المخاطر، وموافقة المسؤول":"FAL license, RER registration, risk disclosures, and responsible officer approval"},
      {n:4,icon:"🛡️",title:ar?"مراجعة الإدارة":'Admin Review',desc:ar?"فريق المنصة يراجع الطلب ويتحقق من صحة المستندات":"Platform team reviews and verifies all documents and compliance"},
      {n:5,icon:"💰",title:ar?"استثمر واكسب":'Invest & Earn',desc:ar?"المستثمرون يشترون حصصاً ويحققون عوائد من الإيجار وتقدير القيمة":"Investors buy fractions and earn returns from rental income and appreciation"},
