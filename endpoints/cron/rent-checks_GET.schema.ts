...
export type OutputType = { success: boolean; results: { overdue: number; reminders: number; expiring: number; complianceNotices: number; smsSent: number; complianceUpdated: number } };
const API_BASE = "/_api";
