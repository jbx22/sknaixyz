...
export const SuperAdminRoute = MakeProtectedRoute(["superadmin"]);
export const AdminRoute = MakeProtectedRoute(["admin", "superadmin"]);
export const UserRoute = MakeProtectedRoute(["user", "admin", "superadmin"]);
